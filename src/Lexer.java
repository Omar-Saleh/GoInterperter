...
"6:10,3,6:2,0,6:18,7,6,8,6:4,5,6:8,2,4:9,6:7,1:26,6:4,1,6,1:26,6:5,9:2")[0];

	private int yy_rmap[] = unpackFromString(1,14,
"0,1,2:2,3,2,3:2,4,2,5:3,6")[0];

	private int yy_nxt[][] = unpackFromString(7,10,
"-1,1,2,3,8,4,9,3,12,5,-1,1:2,-1,1,-1:16,7:4,6,7:3,-1:3,8,-1,8,-1:6,11:2,-1," +
"11:4,10,-1:10,5");
